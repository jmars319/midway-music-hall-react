# Executive Summary
- Midway Music Hall (MMH) runs a React single-page application backed by a PHP router so the public site (`frontend/src/SinglePageLanding.js`, `frontend/src/components/*`) and API (`backend/index.php`) stay in one monorepo.
