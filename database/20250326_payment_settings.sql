...
CREATE TABLE IF NOT EXISTS payment_settings (
  ...
  provider_type ENUM('external_link','paypal_hosted_button','square') NOT NULL DEFAULT 'external_link',
...
CALL add_column_if_missing(@TARGET_DB, 'payment_settings', 'provider_type', 'provider_type ENUM(''external_link'',''paypal_hosted_button'',''square'') NOT NULL DEFAULT ''external_link'' AFTER provider_label');
