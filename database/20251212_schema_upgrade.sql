...
CALL add_column_if_missing(@TARGET_DB, 'events', 'pricing_config', 'pricing_config JSON DEFAULT NULL AFTER max_ticket_price');
CALL add_column_if_missing(@TARGET_DB, 'events', 'ticket_type', 'ticket_type ENUM(''general_admission'',''reserved_seating'',''hybrid'') DEFAULT ''general_admission'' AFTER pricing_config');
