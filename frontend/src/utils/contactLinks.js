...
export const CONTACT_LINK_CLASSES = 'inline-flex items-center gap-2 px-2 py-2 min-h-[40px] rounded-md text-purple-100 underline decoration-purple-400/60 decoration-2 underline-offset-4 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-300 transition';
